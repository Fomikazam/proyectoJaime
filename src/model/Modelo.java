...
public class Modelo {
	...
	public HashMap<Integer, Personaje> leer()
			throws IOException, ClassNotFoundException, EOFException, JDOMException, SQLException { return null; }
	public HashMap<Integer, Arma> leerArma() throws SQLException, IOException { return null; }

	public Personaje buscar(int keyB) throws SQLException, IOException { return null;}
	public Arma buscarArma(int keyB) throws SQLException, IOException { return null; 	}
	...
	public void modificar(Personaje auxiliar, Personaje p) throws IOException, ClassNotFoundException {	}
	...
	public boolean comprobarNombreArma(String nombre, HashMap<Integer, Arma> mapaW) throws SQLException {
		for (Map.Entry<Integer, Arma> entry : mapaW.entrySet()) {
	...
	public void modificar(HashMap<Integer, Personaje> mapa, Personaje personaje)
			throws IOException, ClassNotFoundException, SQLException, IOException {
		mapa.put(personaje.getId(), personaje);
		escribir(mapa);
	}

	public boolean comprobarNombre(String nombre, HashMap<Integer, Personaje> mapa) throws IOException {
